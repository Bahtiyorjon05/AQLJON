...
class PDFGenerator(BaseDocumentGenerator):
    ...
    async def generate(self, update: Update, context: ContextTypes.DEFAULT_TYPE, topic: str, content_context: str = ""):
        ...
        try:
            ...
            1. Provides comprehensive but medium-detailed coverage based on the topic type (not too detailed nor too brief)
            2. Uses an appropriate structure for a PDF document with proper sections
            ...
            13. Do not include any "Generated by", "Prepared by", "Prepared on", "Document on [topic]", or similar robotic phrases
    ...
    def _create_pdf_document(self, content, tmp_path, topic, filename):
        ...
        try:
            ...
            # Build PDF document with UTF-8 encoding
            doc.build(story)
